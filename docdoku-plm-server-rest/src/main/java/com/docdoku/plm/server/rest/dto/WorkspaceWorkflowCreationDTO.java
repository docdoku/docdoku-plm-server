...
@ApiModel(value="WorkspaceWorkflowCreationDTO", description="Use this class to create a new {@link com.docdoku.plm.server.core.workflow.WorkspaceWorkflow} entity")
