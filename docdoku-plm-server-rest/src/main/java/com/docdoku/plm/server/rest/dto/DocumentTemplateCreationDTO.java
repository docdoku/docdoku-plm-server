...
@ApiModel(value="DocumentTemplateCreationDTO", description="Use this class to create a new {@link com.docdoku.plm.server.core.document.DocumentTemplateMaster} entity")
