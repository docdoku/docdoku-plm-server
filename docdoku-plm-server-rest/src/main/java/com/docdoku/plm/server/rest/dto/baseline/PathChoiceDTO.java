...
import com.docdoku.plm.server.rest.dto.PartUsageLinkDTO;
...
@ApiModel(value="PathChoiceDTO", description="This class is the representation of {@link com.docdoku.plm.server.core.configuration.PathChoice} entity")
