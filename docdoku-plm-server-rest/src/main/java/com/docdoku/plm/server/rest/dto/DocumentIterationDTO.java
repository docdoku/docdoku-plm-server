...
@ApiModel(value="DocumentIterationDTO", description="This class is the representation of a {@link com.docdoku.plm.server.core.document.DocumentIteration} entity")
