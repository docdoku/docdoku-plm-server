...
@ApiModel(value="ProductConfigurationDTO", description="This class is the representation of {@link com.docdoku.plm.server.core.configuration.ProductConfiguration} entity")
