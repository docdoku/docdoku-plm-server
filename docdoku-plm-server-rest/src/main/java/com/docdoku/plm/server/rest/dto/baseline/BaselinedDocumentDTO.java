...
@ApiModel(value="BaselinedDocumentDTO", description="This class is the representation of a {@link com.docdoku.plm.server.core.configuration.BaselinedDocument} entity")
