...
@ApiModel(value="BaselinedPartOptionDTO", description="This class holds status and iteration information of a {@link com.docdoku.plm.server.core.configuration.BaselinedPart} entity")
