...
import com.docdoku.plm.server.rest.dto.PathToPathLinkDTO;
...
@ApiModel(value="ProductBaselineDTO", description="This class is the representation of {@link com.docdoku.plm.server.core.configuration.ProductBaseline} entity")
