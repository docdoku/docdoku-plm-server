...
@ApiModel(value="PathListDTO", description="This class holds a list of strings representing multiple sequences of {@link com.docdoku.plm.server.core.product.PartLink} entities")
