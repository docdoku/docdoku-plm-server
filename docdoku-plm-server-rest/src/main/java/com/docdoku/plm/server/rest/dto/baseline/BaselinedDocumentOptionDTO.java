...
@ApiModel(value="BaselinedDocumentOptionDTO", description="This class holds status and iteration information of a {@link com.docdoku.plm.server.core.configuration.BaselinedDocument} entity")
