...
@ApiModel(value="InstanceAttributeTemplateDTO", description="This class is the representation of an {@link com.docdoku.plm.server.core.meta.InstanceAttributeTemplate} entity")
