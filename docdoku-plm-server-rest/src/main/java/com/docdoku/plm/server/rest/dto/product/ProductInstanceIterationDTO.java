...
@ApiModel(value="ProductInstanceIterationDTO", description="This class is the representation of {@link com.docdoku.plm.server.core.configuration.ProductInstanceIteration} entity")
