...
public class GCMSenderBean implements IGCMSenderLocal {
    ...
    private static final String CONF_PROPERTIES = "/com/docdoku/plm/server/gcm/gcm.properties";
